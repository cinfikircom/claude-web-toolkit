...
## Değişmez kurallar
1. **Onay almadan kod değiştirme.** Risk etiketi (Low/Medium/High) ver. Detay: `skills/seo-geo-audit/references/code-safety.md`.
...
- **İş hedefi (A)** → `skills/seo-geo-audit/references/business-goal.md` — birincil/ikincil hedef, önerileri 🟢/🟡/⚪ etiketle.
- **Rakip & içerik boşluğu (B)** → `skills/seo-geo-audit/references/competitor-content-gap.md` — 5 rakibi WebFetch ile incele, gap tablosu.
- **Topical authority (C)** → `skills/seo-geo-audit/references/topical-authority.md` — pillar/cluster haritası + eksikler + iç linkleme.
- **CRO (J)** → `skills/seo-geo-audit/references/cro-audit.md` — CTA/form/telefon/WhatsApp/mobil akış; CWV'yi bozma.

## Çalışma akışı
1. `seo-gorev-listesi.md`'yi oku; iş hedefini netleştir (A).
...
5. `seo-gorev-listesi.md`'yi güncelle + son rapora İş Hedefi/Rakip/CRO bölümlerini ekle.
