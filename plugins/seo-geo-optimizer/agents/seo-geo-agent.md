...
- **GEO / AI citation (D)** → `skills/seo-geo-audit/references/geo-citation.md` — birincil cevap, özet, FAQ, entity tanımı.
- **llms.txt / ai-agents.json (D)** → `skills/seo-geo-audit/references/llms-txt-generator.md` + `templates/{llms.txt,llms-full.txt,ai-agents.json}.template`.
- **Klasik SEO & E-E-A-T (F)** → `skills/seo-geo-audit/references/semantic-structure.md`, `eeat-quality-rater.md`, `sources.md` (#4,#5).
- **Yerel SEO (G)** → `skills/seo-geo-audit/references/local-seo.md` — NAP, `LocalBusiness`, yerel landing page.
- **Crawlability & AI bot (H)** → `skills/seo-geo-audit/references/ai-crawler-audit.md` (+ `templates/robots-ai.txt.template`);
  Cloudflare arkasındaysa bot bloklaması → `skills/seo-geo-audit/references/cloudflare-edge.md`.

## Çalışma akışı
1. `seo-gorev-listesi.md`'yi oku; mevcut SEO/GEO altyapısını tespit et.
...
4. `seo-gorev-listesi.md`'yi güncelle + son rapora ilgili bölümleri ekle.
